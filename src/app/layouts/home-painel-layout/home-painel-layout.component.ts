...
@Component({
  selector: 'app-home-painel-layout',
  templateUrl: './home-painel-layout.component.html',
  styleUrls: ['./home-painel-layout.component.css']
})
export class HomePainelLayoutComponent implements OnInit {
